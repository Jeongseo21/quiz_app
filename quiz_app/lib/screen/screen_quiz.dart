...
class _QuizScreenState extends State<QuizScreen> {
  ...
  int _currentIndex = 0;
  SwiperController _controller = SwiperController(); //다음 문제로 이동하기 위해서
            ...
            child: Center(
              child: ButtonTheme(
                ...
                child: RaisedButton(
                  ...
                  onPressed: _answers[_currentIndex] == -1 //답을 체크하지 않았다면
                      ? null
                      : () {
                          if (_currentIndex == widget.quizs.length - 1) { //마지막 문제라면
                            Navigator.push(
                              context,
                              MaterialPageRoute(
